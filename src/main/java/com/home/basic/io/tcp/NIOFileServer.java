...
public class NIOFileServer {
        ...
        while (true) {
            ...
            while (it.hasNext()) {
                ...
                if (key.isAcceptable()) {
                    ...
                    File file = new File("Z:\\GHOST_WIN10X64Pro_14393_577\\_windows.GHO");
    ...
    private void readData(long start, SelectionKey key) throws IOException {
        ...
        try {
            while ((num = socketChannel.read(buffer)) > 0) {
                ...
                System.out.println("本次写入字节:" + buffer.position());
                buffer.clear();
            }
        } catch (IOException e) {
            key.cancel();
